    ...
    return (
        ...
        <div>
            ...
            <div className="camaro-mobile-wrapper">
                ...
                <p className="camaro-year" style={{ opacity: yearVisible ? 1 : 0 }}>{camaro.year}</p>
            </div>
            <div className="camaro-content-section">
                <div className="camaro-overlay" style={{ opacity: descVisible ? 1 : 0 }}>
                    {isMobile ? (
                        <div className="right-overlay">
                            <p className="camaro-desc" style={{ opacity: descVisible ? 1 : 0 }}>
                                {camaro.description}
                            </p>
                            <p className="camaro-trims" style={{ opacity: descVisible ? 1 : 0 }}>
                                Trims: {camaro.trims}
                            </p>
                            <p className="camaro-hp" style={{ opacity: descVisible ? 1 : 0 }}>
                                Horsepower - {camaro.horsepower}
                            </p>
                            <p className="camaro-zero" style={{ opacity: descVisible ? 1 : 0 }}>
                                0-60 - {camaro.zeroToSixty}
                            </p>
                            <p className="camaro-msrp" style={{ opacity: descVisible ? 1 : 0 }}>
                                MSRP - {camaro.MSRP}
                            </p>
                            <p className="camaro-forum" style={{ opacity: descVisible ? 1 : 0 }}>
                                More Info - <a href={camaro.forumLink} target="_blank" rel="noopener noreferrer">{camaro.forumLink}</a>
                            </p>
                            <p className="camaro-credit" style={{ opacity: descVisible ? 1 : 0 }}>
